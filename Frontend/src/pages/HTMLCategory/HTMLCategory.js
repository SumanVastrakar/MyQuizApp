...
import { arrayLength, quesNum, restart, shuffleAnswer } from '../../Redux/HTMLPage/action';
import CircleLoader from './Answers';
import { colorA, colorB, colorC, colorD, flag } from '../../Redux/HTMLPage/action';
import HashLoader from "react-spinners/HashLoader"
import CategoryLoading from '../LoadingPage/CategoryLoading';
import QuestionLoading from '../LoadingPage/QuestionLoading';


export default function HTMLCategory() {
...
setLoading(false);
    ...
    const showResults = useSelector(store => store.htmlCurrentques.showResults)
    const correctAnswerCount = useSelector(store => store.htmlCurrentques.correctAnswerCount)
    const A = useSelector(store => store.htmlCurrentques.colorA);
    const B = useSelector(store => store.htmlCurrentques.colorB);
    const C = useSelector(store => store.htmlCurrentques.colorC);
    const D = useSelector(store => store.htmlCurrentques.colorD);
    const F = useSelector(store => store.htmlCurrentques.flag);
